...
#define FOREGROUND_Blue        (FOREGROUND_BLUE)
...
#define FOREGROUND_Gray        (FOREGROUND_INTENSITY)//灰色
#define FOREGROUND_Pink        (FOREGROUND_INTENSITY|FOREGROUND_Purple)//粉色
...
#define FOREGROUND_HighWhite   (FOREGROUND_INTENSITY|FOREGROUND_White)
//background color
#define BACKGROUND_Red         (BACKGROUND_RED)
#define BACKGROUND_Green       (BACKGROUND_GREEN)
#define BACKGROUND_Blue        (BACKGROUND_BLUE)
#define BACKGROUND_Yellow      (BACKGROUND_RED|BACKGROUND_GREEN)
#define BACKGROUND_Purple      (BACKGROUND_RED|BACKGROUND_BLUE)//紫色
#define BACKGROUND_Cyan        (BACKGROUND_GREEN|BACKGROUND_BLUE)//青色
#define BACKGROUND_White       (BACKGROUND_RED|BACKGROUND_GREEN|BACKGROUND_BLUE)
#define BACKGROUND_Gray        (BACKGROUND_INTENSITY)//灰色
#define BACKGROUND_Pink        (BACKGROUND_INTENSITY|BACKGROUND_Purple)//粉色
...
#define BACKGROUND_HighWhite (BACKGROUND_INTENSITY|BACKGROUND_White)
